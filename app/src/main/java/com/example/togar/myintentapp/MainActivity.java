package com.example.togar.myintentapp;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    private Button btnMoveActivity, btnMoveDataActivity, btnMoveWithObject, btnDialPhone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMoveDataActivity = (Button)findViewById(R.id.btn_move_activity_data);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "082210332958";
